...
declare module 'prtc-sdk-web' {
  import { Client } from '__prtc-sdk-web/client';
  import { LocalStream, LocalStreamOptions } from '__prtc-sdk-web/stream/local-stream';
  import { generateToken } from '__prtc-sdk-web/utils/token';
  import { ClientOptions } from '__prtc-sdk-web/types';
  import { LogLevel } from '__prtc-sdk-web/logger';
  /**
    * 创建客户端
  ...
  export * from '__prtc-sdk-web/devices';
  export * from '__prtc-sdk-web/client';
  export * from '__prtc-sdk-web/types';
  export * from '__prtc-sdk-web/event';
  export * from '__prtc-sdk-web/error';
  export * from '__prtc-sdk-web/user/user';
  export * from '__prtc-sdk-web/stream/types';
  export * from '__prtc-sdk-web/stream/stream';
  export * from '__prtc-sdk-web/stream/local-stream';
  export * from '__prtc-sdk-web/stream/remote-stream';
  export * from '__prtc-sdk-web/server';
  export * from '__prtc-sdk-web/plugin';
  export * from '__prtc-sdk-web/version';
  /************** 4 plugin ****************/
  export { Client };
  export { LocalStream };
  export { RemoteStream } from '__prtc-sdk-web/stream/remote-stream';
}

declare module '__prtc-sdk-web/client' {
  import { RtcEventType } from '__prtc-sdk-web/event';
  import { Listener } from '__prtc-sdk-web/event-emitter';
  import { LocalStream } from '__prtc-sdk-web/stream/local-stream';
  import { RemoteStream } from '__prtc-sdk-web/stream/remote-stream';
  import { User } from '__prtc-sdk-web/user/user';
  import { JoinOptions, RoleType } from '__prtc-sdk-web/types';
  import { ClientPlugin } from '__prtc-sdk-web/plugin';
  /**
...
declare module '__prtc-sdk-web/stream/local-stream' {
  import { Stream } from '__prtc-sdk-web/stream/stream';
  import { PlayOptions } from '__prtc-sdk-web/types';
  import { SwitchDeviceType } from '__prtc-sdk-web/stream/types';
  import { VideoProfile, ScreenProfile, CustomVideoProfile } from '__prtc-sdk-web/stream/profile';
  import { StreamPlugin } from '__prtc-sdk-web/plugin';
  /**
    * 创建本地流的参数
    * @public
    */
...
declare module '__prtc-sdk-web/utils/token' {
  /**
...
declare module '__prtc-sdk-web/types' {
  import { AudioCodec, VideoCodec } from '__prtc-sdk-web/stream/types';
  /**
    * 视频播放时的显示模式
    * - cover 模式：优先保证视窗被填满。
  ...
  export { /*AudioProfile,*/ VideoProfile, ScreenProfile } from '__prtc-sdk-web/stream/profile';
  /**
    * 房间类型
    * @public
    */
...
declare module '__prtc-sdk-web/logger' {
  /**
    * 日志级别
    */
...
declare module '__prtc-sdk-web/devices' {
  import { Codecs } from '__prtc-sdk-web/types';
  /**
...
declare module '__prtc-sdk-web/event' {
  import { User } from '__prtc-sdk-web/user/user';
  import { Stream } from '__prtc-sdk-web/stream/stream';
  import { ConnectionStates } from '__prtc-sdk-web/connection/types';
  import { LocalStream } from '__prtc-sdk-web/';
  import { RemoteStream } from '__prtc-sdk-web/stream/remote-stream';
  /**
    * Rtc 用户事件类型：
    *
...
declare module '__prtc-sdk-web/error' {
  /**
    * RTC 错误信息
...
declare module '__prtc-sdk-web/user/user' {
  /**
    * 用户信息
    * @public
    */
...
declare module '__prtc-sdk-web/stream/types' {
  /**
    * 音频编解码格式
    * @public
    */
...
declare module '__prtc-sdk-web/stream/stream' {
  import { EventEmitter } from '__prtc-sdk-web/event-emitter';
  import { PlayOptions, SnapshotOptions } from '__prtc-sdk-web/types';
  import { MediaType, StreamStats } from '__prtc-sdk-web/stream/types';
  /**
...
declare module '__prtc-sdk-web/stream/remote-stream' {
  import { Stream } from '__prtc-sdk-web/stream/stream';
  import { StreamPlugin } from '__prtc-sdk-web/plugin';
  /**
...
declare module '__prtc-sdk-web/server' {
  /**
...
declare module '__prtc-sdk-web/plugin' {
  /**
    * @public
    */
...
declare module '__prtc-sdk-web/version' {
  /**
    * 当前 sdk 的版本号
    * @public
    */
...
declare module '__prtc-sdk-web/event-emitter' {
  import { RtcEventType, RtcUserEventType, RtcUserEvent, RtcStreamEvent, RtcConnectionEventType, RtcConnectionEvent, RtcStreamEventType, RtcPlayerEventType, RtcPlayerEvent } from '__prtc-sdk-web/event';
  /**
    * 事件监听函数
    * 其中 T 为 RtcEvent 泛型
    * @private
...
declare module '__prtc-sdk-web/stream/profile' {
  /**
    * 预设的视频 Profile
    *
...
declare module '__prtc-sdk-web/connection/types' {
  /**
    * 连接状态类型：
    * - OPEN - 已连接
    * - CONNECTING - 连接中
